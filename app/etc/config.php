...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'connector_dynamic_content' => [
                ...
                'external_dynamic_content_urls' => [
                    'passcode' => 'PJLWPh0062X6EIMBYERKwqYM0GYGK88n',
            ...
            'msp_securitysuite_twofactorauth' => [
                ...
                'duo' => [
                    'application_key' => 'wXoj8KIYhpMHPxGDRDy2QappUQpxGP9LoJxMSh3FoUZZbEbVBdMxI25I7HlBgNH3',
                ],
            ],
            'yotpo' => [
                'env' => [
                ...
                'sync_settings' => [
                    ...
                    'orders_sync_start_date' => '2019-11-12',
                ],
                'module_info' => [
                    'yotpo_installation_date' => '2019-11-12',
                ],
            ],
        ],
        'stores' => [
    ...
    'themes' => [
        ...
        'frontend/test/ultimate' => [
            ...
            'theme_path' => 'test/ultimate',
            'theme_title' => 'Test Ultimate',
            'is_featured' => '0',
            'area' => 'frontend',
            'type' => '0',
            'code' => 'test/ultimate',
